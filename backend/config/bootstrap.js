...
const WEB_PREFIX = "";
function loadRoutes(app, basePath, prefix) {
    return __awaiter(this, void 0, void 0, function* () {
        const entries = yield (0, promises_1.readdir)(basePath, { withFileTypes: true });
...
function bootstrapRoutes(app) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield loadRoutes(app, apiRoutesPath, API_PREFIX);
        // Load Web routes
        const webRoutesPath = (0, path_1.join)(__dirname, "../app/routes/web");
        yield loadRoutes(app, webRoutesPath, WEB_PREFIX);
    });
}
